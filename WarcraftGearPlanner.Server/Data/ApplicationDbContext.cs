...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
	...
	public DbSet<ItemQualityEntity> ItemQualities { get; set; } = null!;
	public DbSet<InventoryTypeEntity> InventoryTypes { get; set; } = null!;
	public DbSet<RealmEntity> Realms { get; set; } = null!;
	public DbSet<ItemEntity> Items { get; set; } = null!;

	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		var entities = typeof(BaseEntity).Assembly.GetTypes().Where(x =>
			x.IsClass
			&& !x.IsAbstract
